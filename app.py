...
from models import db, Game, Platform, Company, Genre, GameEngine, GameEngineLogo, game_platform, game_genre, game_game_engine, company_game_engine, game_engine_logo, GameEngineLogos
...
def entreprise_detail(slug):
    ...
    # Récupérer les logos des moteurs graphiques
