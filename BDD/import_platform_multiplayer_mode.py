...
csv_path = r"C:\Users\User\Documents\Data-Game\data-game\csv\platform_multiplayer_mode.csv"

query = f"""
LOAD DATA LOCAL INFILE '{csv_path.replace("\\", "/")}'
INTO TABLE platform_multiplayer_mode
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"' 
LINES TERMINATED BY '\\n'
IGNORE 1 LINES
(multiplayer_mode_id, platform_id);
"""
