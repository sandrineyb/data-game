...
csv_path = r"C:\Users\User\Documents\Data-Game\data-game\csv\game_player_perspective_exploded.csv"

query = f"""
LOAD DATA LOCAL INFILE '{csv_path.replace("\\", "/")}'
INTO TABLE game_player_perspective
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"' 
LINES TERMINATED BY '\\n'
IGNORE 1 LINES
(game_id, perspective_id);
"""
